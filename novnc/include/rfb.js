...
/* Modifications to the original code from Joel Martin were funded by a grant from the 
 * National Science Foundation:  -- CC*IIE IAM:  Data at the Speed of Trust (ACI-1440588; PI: Tracy Futhey)
 * and are Copyright (c) 2016 Duke University.  
 */

/* Replace "your-proconsul-server.domain" below with the fqdn for your Proconsul server. */
...
// Originally check_rate = 217 and fbu_req_rate=1413
    ['check_rate',         'rw', 'int', 10,  'Timing (ms) of send/receive check'],
    ['fbu_req_rate',       'rw', 'int', 15, 'Timing (ms) of frameBufferUpdate requests'],
...
fail = function(msg) {
  window.location="https://your-proconsul-server.domain/proconsul/";
  return false;
}
